<%@ page language="C#" masterpagefile="~/Reconcilation.master" autoeventwireup="true" inherits="Reconciliation, App_Web_ge7ytt8w" title="MANUAL RECONCILIATION" enableviewstatemac="false" %>
<%@ Register 
                    ...
                    <tr>
                        ...
                        <td style="width: 40%; text-align: center">
                            <asp:Button ID="btnReconcile" runat="server" Font-Size="9pt" Height="23px" OnClick="btnReconcile_Click"
                                Text="RECONCILE TRANSACTIONS" Width="239px" style="font: menu" /></td>
