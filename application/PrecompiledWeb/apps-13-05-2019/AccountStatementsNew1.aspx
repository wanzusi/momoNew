<%@ page language="C#" masterpagefile="~/ReportMaster.master" autoeventwireup="true" inherits="AccountStatements, App_Web_szxjlzxw" title="AccountStatements" enableviewstatemac="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%">
        <tr>        <td style="width: 35%; height: 2px">
                                    ...
                                    <tr>
                                        <td align="center" style="width: 98%; height: 5px">
                                            <asp:Button ID="btnDownload" runat="server" Font-Size="9pt" Height="23px" OnClick="btnDownload_Click"
                                                Style="font: menu" Text="Download Statement(PDF)" Width="150px" />
                                            <asp:Button ID="btnDownloadExcel" runat="server" Font-Size="9pt" Height="23px" OnClick="btnDownloadExcel_Click"
                                                Style="font: menu" Text="Download Statement(EXCEL) " Width="150px" /></td>
                                    </tr>
                                    <tr>
                                        <td align="center" style="width: 98%; height: 5px">
                                        </td>
            ...
            <td style="width: 40%; height: 2px">
                <asp:Label ID="lblTotal" runat="server" Font-Bold="True" ForeColor="#0000C0" Text="."></asp:Label></td>
                    ...
                    <asp:View ID="View2" runat="server"><table style="width: 100%">
                        <tr>
                            <td align="center" style="width: 96%; height: 5px">
                            </td>
                        </tr>
                        <tr>
                            <td align="center" style="width: 96%; height: 5px">
                        ...
                        <tr>
                            <td style="width: 96%; height: 5px"><asp:Button ID="btnReturn" runat="server" Font-Size="9pt" Height="23px" OnClick="btnReturn_Click"
