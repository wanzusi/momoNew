<%@ page language="C#" masterpagefile="~/AccountantMaster.master" autoeventwireup="true" inherits="AddCorporateBeneficiary, App_Web_xqryrb4f" title="ACCOUNTS" enableviewstatemac="false" %>
<%@ Register 
                                                                ...
                                                                <td style="vertical-align: top; width: 48%; height: 10px; text-align: left">
                                                                    <table align="center" cellpadding="0" cellspacing="0" style="width: 98%">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="InterFaceTableRightRow" style="width: 66%; height: 20px">
                                                                                <asp:DropDownList ID="cboNetwork" runat="server" CssClass="InterfaceDropdownList"
                                                                                    OnDataBound="cboNetwork_DataBound" Style="font: menu" Width="85%">
                                                                                </asp:DropDownList></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="InterFaceTableLeftRowUp" style="height: 20px">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="InterFaceTableRightRow" style="width: 66%; height: 20px">
                                                                                <asp:TextBox ID="txt_reason" runat="server"></asp:TextBox></td>
                                                                        </tr>
                                                                    </table>
                                                                    &nbsp;</td>
                                                            </tr>
