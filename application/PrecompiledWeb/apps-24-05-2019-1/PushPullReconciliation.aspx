<%@ page language="C#" masterpagefile="~/Reconcilation.master" autoeventwireup="true" inherits="AutoReconciliation, App_Web_gbzbmyco" title="AUTO RECONCILIATION" enableviewstatemac="false" %>
                        ...
                        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                               <%-- <asp:BoundColumn DataField="No." HeaderText="No.">
                                ...
                                <asp:BoundColumn DataField="PegasusStatus" HeaderText="STATUS">
                                ...
                                <asp:BoundColumn DataField="Recieved" HeaderText="FOUND AT PEGASUS">
                                    <HeaderStyle Width="15%" />
                                </asp:BoundColumn>
