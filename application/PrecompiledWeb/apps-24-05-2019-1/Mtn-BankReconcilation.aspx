<%@ page language="C#" masterpagefile="~/Reconcilation.master" autoeventwireup="true" inherits="DisonPushPull, App_Web_7q_oyp4k" title="Untitled Page" enableviewstatemac="false" %>
                            ...
                            <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                                <tr>
                                    <td class="InterfaceHeaderLabel">
                                        MTN-BANK FILE RECONCILIATION</td>
                                </tr>
                            </table>
            </td>
        </tr>
                        ...
                        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                               <%-- <asp:BoundColumn DataField="No." HeaderText="No.">
                                ...
                                <asp:BoundColumn DataField="MTNVendorRef" HeaderText="MTN Agent Ref">
                                    <HeaderStyle Width="20%" />
                                    <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="BANKVendorRef" HeaderText="Bank Vendor Ref">
                                    <HeaderStyle Width="15%" />
                                    <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" />
                                </asp:BoundColumn>
                               
                                <asp:BoundColumn DataField="MTNBANKVendorRefStatus" HeaderText="STATUS">
