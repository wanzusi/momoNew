<%@ page language="C#" masterpagefile="~/CustomerPayments.master" autoeventwireup="true" inherits="ViewPayBatches, App_Web_-3odv96y" title="VIEW PAYMENT BATCHES" enableviewstatemac="false" %>
    ...
    <table style="width: 100%">
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 90%; border-right: #617da6 1px solid; border-top: #617da6 1px solid; border-left: #617da6 1px solid; border-bottom: #617da6 1px solid;">
                    ...
                    <tr>
                        ...
                        <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                            ...
                            <asp:DropDownList ID="cboScheduleStatus" runat="server" CssClass="SystemDropdownListOthers DataEntryFormTableTextboxWidth"
                              Width="90%">
                                <asp:ListItem Selected="True" Value="0">All</asp:ListItem>
                                <asp:ListItem Value="1">Paused</asp:ListItem>
            ...
            <td style="width: 98%; height: 2px">
                &nbsp;<asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="FullName" HeaderText="SCHEDULED BY">
                            <HeaderStyle Width="10%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="ScheduleDate" HeaderText="SCHEDULE TIME">
                            <HeaderStyle Width="10%" />
                        </asp:BoundColumn>
                    </Columns>
        ...
        <asp:View ID="View2" runat="server">
            <table style="width: 100%">
                ...
                <tr>
                    <td style="width: 98%; height: 2px">
                        <asp:Label ID="lblTotal" runat="server" Font-Bold="True" Text="."></asp:Label></td>
                </tr>
            </table>
        </asp:View>
        <asp:View ID="View3" runat="server"><table style="width: 100%">
            <tr>
                <td class="InterfaceHeaderLabel2" style="width: 98%; height: 2px">
                    Edit Schedule Details</td>
            </tr>
            <tr>
                <td style="width: 98%; height: 2px">
                </td>
            ...
            <tr>
                <td style="width: 98%; height: 2px">
                    <table align="center" cellpadding="0" cellspacing="0" style="border-right: #617da6 1px solid;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="InterFaceTableRightRow" style="height: 20px">
                                                        <asp:DropDownList ID="cboFromAccount" runat="server" AutoPostBack="True" CssClass="SystemDropdownListOthers DataEntryFormTableTextboxWidth"
                                                            OnDataBound="cboFromAccount_DataBound" OnSelectedIndexChanged="cboFromAccount_SelectedIndexChanged"
                                                            Width="80%">
                                                        </asp:DropDownList></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="InterFaceTableRightRow">
                                                        <asp:TextBox ID="txtBatchTotal" runat="server" CssClass="DataEntryFormTableTextbox DataEntryFormTableTextboxWidth"
                                ...
                                &nbsp;<table align="center" cellpadding="0" cellspacing="0" style="border-right: #617da6 1px solid;
                                    ...
                                    <tr>
                                        <td colspan="2" style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                                            ...
                                            border-top-color: #617da6; height: 23px; text-align: center; border-right-width: 1px;
                                            border-right-color: #617da6">
                                            <asp:RadioButtonList ID="rbnSchedule" runat="server" BackColor="WhiteSmoke" Font-Bold="True"
                                                OnSelectedIndexChanged="rbnApproval_SelectedIndexChanged" RepeatDirection="Horizontal"
                                                Width="100%" AutoPostBack="True">
                                                <asp:ListItem Value="1">Send Schedule </asp:ListItem>
                                                <asp:ListItem Value="2">Re ScheduleBatch </asp:ListItem>
                                                <asp:ListItem Value="3">Cancel </asp:ListItem>
                                                <asp:ListItem Value="4">Pause </asp:ListItem>
                        ...
                        <tr>
                            <td colspan="4" style="vertical-align: middle; height: 15px; text-align: center">
                                <asp:Button ID="btnYes" runat="server" Text="SUBMIT" Font-Bold="True" OnClick="btnYes_Click" Width="105px" />
                                <asp:Button ID="btnCancel" runat="server" Text="RETURN" Font-Bold="True" OnClick="btnCancel_Click" Width="105px" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
