<%@ page language="C#" masterpagefile="~/ReportMaster2.master" autoeventwireup="true" inherits="AgentTransactions, App_Web_sxogr9jo" title="TRANSACTIONS" enableviewstatemac="false" %>
            ...
            <td style="width: 98%; height: 5px">
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 98%; border-right: #617da6 1px solid;
                    ...
                    <td style="vertical-align: middle; width: 17%; height: 23px; text-align: center;
                            ...
                            border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px;
                            border-right-color: #617da6;">
                            <asp:DropDownList ID="cboTranStatus" runat="server" CssClass="InterfaceDropdownList"
                                OnDataBound="cboTranState_DataBound" Style="font: menu" Width="50%">
                            </asp:DropDownList>&nbsp;</td>
                        ...
                        <td style="vertical-align: middle; width: 17%; height: 23px; text-align: center;
                            ...
                            border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px;
                            border-right-color: #617da6;">
                            <asp:Label ID="Label1" runat="server" Text="Search by phone number"></asp:Label>
                            <asp:TextBox ID="phoneNum" runat="server" MaxLength="13"></asp:TextBox>
            ...
            <td style="width: 98%; height: 2px">
                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="Reason" HeaderText="Tran Reason">
                            <HeaderStyle Width="10%" />
                            <ItemStyle Width="10%" />
                        </asp:BoundColumn>
                    </Columns>
