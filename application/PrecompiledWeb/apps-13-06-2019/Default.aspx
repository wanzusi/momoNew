<%@ page language="C#" autoeventwireup="true" inherits="_Default, App_Web_bgrhhaa1" enableeventvalidation="false" culture="auto" uiculture="auto" enableviewstatemac="false" %>
...
<body bgcolor="#EFFBF5">
    <form id="form1" runat="server">
        ...
        <table cellpadding="0" cellspacing="0" class="style12">
            <tr>
                <td style="vertical-align: top; text-align: center; background-color: white; width: 1107px;">
                    <table style="border: 1px solid #EEEEEE; width: 100%; background-color: #ffffff;
                        padding-top: 0px; margin-top: 0px;">
                        <tr>
                            <td style="border-right: thin solid #ebf3ff; background-color: #acbd29; padding-right: 0px;
                                margin-right: 0px; height: 2px;" colspan="2">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 99%">
                                ...
                                <div class="ddcolortabsline" style="height: 1px; background-color: #990033">
                                    &nbsp;</div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="width: 1%">
                                &nbsp;</td>
                            <td style="width: 99%">
                                <table align="left" class="style13" style="padding-right: 3px; padding-left: 3px;
                                    padding-bottom: 3px; margin: 3px; padding-top: 3px; height: 300px; background-color: #fafafa;
                                                        ...
                                                        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                                                            <asp:View ID="View2" runat="server">
                                                                ...
                                                                <asp:Panel ID="Panel1" runat="server" CssClass="roundedPanel" Width="100%">
                                                                    <table align="center" cellpadding="0" cellspacing="0" style="width: 35%; border-right: #617da6 1px solid;
                                                                        border-top: #617da6 1px solid; border-left: #617da6 1px solid; border-bottom: #617da6 1px solid;" id="TABLE1" onclick="return TABLE1_onclick()">
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="InterFaceTableRightLogin" style="width: 50%; height: 30px;">
                                                                                <asp:TextBox ID="txtUsername" runat="server" Width="60%" onblur="Change(this, event)"
                                                            ...
                                                            <asp:View ID="View1" runat="server">
                                                                <table align="center" cellpadding="0" cellspacing="0" style="width: 45%; border-right: #617da6 1px solid;
                                                                    ...
                                                                    <tr>
                                                                        <td class="InterFaceTableLeftRowUp" style="width: 100%; text-align: center">
                                                                            <asp:Label ID="lblQn" runat="server" Font-Bold="True" ForeColor="Maroon" Text="."></asp:Label><asp:Button
                                                                                ID="btnYes" runat="server" OnClick="btnYes_Click" Text="Yes" Font-Bold="True"
                                                                                Width="53px" />&nbsp;
                                                                            <asp:Button ID="btnNo" runat="server" OnClick="btnNo_Click" Text="No" Font-Bold="True"
                                                                                Width="52px" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width: 100px">
                                    ...
                                    <table cellpadding="0" cellspacing="0" style="width: 45%; border-right: #617da6 1px solid;
                                                                    border-top: #617da6 1px solid; border-left: #617da6 1px solid; border-bottom: #617da6 1px solid; text-align: center;">
                                                                    <tr>
                                                                        <td colspan="3">
                                                                            <table align="center" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                                <tr>
                                                                                    <td class="InterfaceHeaderLabel">
                                                                                        ENTER ONE TIME PIN SENT TO EMAIL OR PHONE</td>
                                                                                </tr>
                                                                            </table>
                                                                            <span style="font-family: Cambria">(check in spam if mail not delivered in 3 minutes)</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="3" style="height: 20px">
                                                                <asp:TextBox ID="PinPrompt" runat="server" TextMode="Password" Width="200px"/></td>
                                                                    </tr>
                                        <tr>
                                            <td colspan="3" style="height: 20px">
                                                                              
                                                                               
                                                                                <asp:Button ID="BtnPromptResend" runat="server" Font-Bold="True" Font-Size="9pt" Height="23px"
                                                                                OnClick="BtnPromptResend_Click" Text="ResendOTP" Width="90px" />&nbsp;
                                                                            <asp:Button ID="BtnPinPrompt" runat="server" Font-Bold="True" Font-Size="9pt" Height="23px"
                                                                                OnClick="BtnPinPrompt_Click" Text="Submit OTP" Width="99px" />
                                                                            <asp:Button ID="BtnPinPromptCancel" runat="server" Font-Bold="True" Font-Size="9pt" Height="23px"
                                                                                OnClick="BtnPinPromptCancel_Click" Text="Cancel" Width="90px" /></td>
                                        </tr>
                                                                        <tr>
            ...
            <tr>
                <td style="font-family: Tahoma; font-size: 13px; vertical-align: top; text-align: center;
                    background-color: #EEEEEE; height: 45px; width: 1107px;">
                    <div id="copyinfo" style="padding: 10px 0pt 20px; background-color: #acbd29; text-transform: uppercase;
                        color: white; font-weight: bold; font-family: 'Courier New';">
                       <%-- <div class="a2a_kit a2a_kit_size_32 a2a_default_style">
                            <a class="a2a_dd" href="http://www.pegasustechnologies.co.ug/">About Us</a>
                        </div>--%>
                        © 2016, PEGASUS TECHNOLOGIES</div>
                </td>
            </tr>
        </table>
        <br />
