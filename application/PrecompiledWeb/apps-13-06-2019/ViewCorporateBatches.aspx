<%@ page language="C#" masterpagefile="~/CustomerPayments.master" autoeventwireup="true" inherits="ViewPayBatches, App_Web_b9azzvee" title="VIEW PAYMENT BATCHES" enableviewstatemac="false" %>
...
<%@ Register 
 ...
 TagPrefix="ajaxToolkit" %>
    ...
    <asp:MultiView ID="MultiView5" runat="server">
        <asp:View ID="View7" runat="server">
            <table style="width: 100%">
                ...
                <tr>
                    <td style="width: 98%; height: 1px"><table align="center" cellpadding="0" cellspacing="0" style="width: 80%; border-right: #617da6 1px solid; border-top: #617da6 1px solid; border-left: #617da6 1px solid; border-bottom: #617da6 1px solid;" id="TABLE1">
                        <tr>
                            <td class="InterfaceHeaderLabel2" style="vertical-align: middle; height: 18px;
                            text-align: center" colspan="4">
                                Approve Payment Batch</td>
    ...
    <ajaxToolkit:CalendarExtender id="CalendarExtender3" runat="server" CssClass="MyCalendar"
        Format="dd MMMM yyyy" PopupPosition="TopLeft" TargetControlID="txtScheduleDate">
    </ajaxToolkit:CalendarExtender>
