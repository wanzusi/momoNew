<%@ page language="C#" masterpagefile="~/ReportMaster2.master" autoeventwireup="true" inherits="GenerateAccountStatement, App_Web_gvr19cr7" title="Generate Account Statement" enableviewstatemac="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%">
        <tr>
            <td style="width: 43%; height: 2px">
                <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                    <tr>
                        <td class="InterfaceHeaderLabel">
                            GENERATE ACCOUNT STATEMENT</td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td style="width: 43%; height: 1px">
            </td>
        </tr>
        <tr>
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 98%; border-right: #617da6 1px solid;
                    ...
                    <tr>
                        <td class="InterfaceHeaderLabel2" style="vertical-align: middle; width: 17%; height: 18px;
                            text-align: center"><asp:Label ID="tran_status" runat="server" Font-Bold="True"  Text="TRANSACTION STATUS">
                </asp:Label>
                        </td>
                        <td class="InterfaceHeaderLabel2" style="vertical-align: middle; width: 17%; height: 18px;
                            text-align: center">
                    ...
                    <tr>
                        <td style="vertical-align: middle; width: 17%; height: 23px; text-align: center;
                            ...
                            <asp:DropDownList ID="cboTranStatus" runat="server" 
                                CssClass="InterfaceDropdownList" OnDataBound="cboTranState_DataBound" 
                                Style="font: menu" Width="95%" OnSelectedIndexChanged="cboTranStatus_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
