<%@ page language="C#" masterpagefile="~/ReportMaster.master" autoeventwireup="true" inherits="TransactionByDistrict, App_Web_zzcpmdng" title="TRANSACTIONS BY DISTRICT" enableviewstatemac="false" %>
                    ...
                    <tr>
                        <td style="vertical-align: middle; width: 25%; height: 23px; text-align: center; border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6; border-bottom-width: 1px; border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px; border-right-color: #617da6;">
                            &nbsp;<asp:DropDownList ID="cboAreas" runat="server" AutoPostBack="True" OnDataBound="cboAreas_DataBound"
                                OnSelectedIndexChanged="cboAreas_SelectedIndexChanged" Style="font: menu" Width="95%">
                            </asp:DropDownList></td>
            ...
            <td style="width: 98%; height: 2px">
                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="Vendor" HeaderText="Bank">
                        ...
                        <asp:BoundColumn DataField="PayDate" HeaderText="Pay Date">
                         ...
                         <asp:BoundColumn DataField="Reconciled" HeaderText="Reconciled">
                            <HeaderStyle Width="10%" />
                            <ItemStyle Width="10%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="ReconciledBy" HeaderText="Reconciler">
                            <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" Width="20%" />
                            <ItemStyle Width="20%" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
