<%@ page language="C#" masterpagefile="~/AccountantMaster.master" autoeventwireup="true" inherits="AccountStatments, App_Web_whvkabwk" title="ACCOUNT STATEMENTS" enableviewstatemac="false" %>
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="border-right: #617da6 1px solid;
                    ...
                    <tr>
                        <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                            ...
                            <asp:TextBox ID="TextBox1" runat="server" Style="font: menu" Width="90%"></asp:TextBox></td>
                        <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                            border-bottom-width: 1px; border-bottom-color: #617da6; vertical-align: middle;
                            width: 17%; border-top-color: #617da6; height: 23px; text-align: center; border-right-width: 1px;
                            border-right-color: #617da6">
                            <asp:DropDownList ID="cboCustomerAccount" runat="server"
                                Width="90%">
                            </asp:DropDownList></td>
                        <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                            border-bottom-width: 1px; border-bottom-color: #617da6; vertical-align: middle;
                    ...
                    <tr>
                        <td colspan="1" style="border-right: #617da6 1px solid; border-top: #617da6 1px solid;
            ...
            <td style="width: 98%; height: 2px">
                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="SerialNo" HeaderText="ACCOUNT.">
                        ...
                        <asp:BoundColumn DataField="Cleared" HeaderText="MADE BY">
                            <HeaderStyle Width="10%" />
                        </asp:BoundColumn>
                    </Columns>
