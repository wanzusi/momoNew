<%@ page language="C#" masterpagefile="~/Main.master" autoeventwireup="true" inherits="AddUser, App_Web_j36b_t4y" title="NEW SYSTEM USER" culture="auto" uiculture="auto" enableviewstatemac="false" %>
 <%@ Register 
                                    ...
                                    <ajaxToolkit:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <table align="center" cellpadding="0" cellspacing="0" style="width: 98%">
                                                <tr>
                                                    ...
                                                    <td class="InterFaceTableRightRow">
                                                        <asp:DropDownList ID="cboUserType" runat="server" AutoPostBack="True" OnDataBound="cboUserType_DataBound"
                                                            OnSelectedIndexChanged="cboUserType_SelectedIndexChanged" Width="60%" style="font: menu">
                                                        </asp:DropDownList></td>
                                                </tr>
                                                <tr>
                                                    <td class="InterFaceTableLeftRowUp" style="width: 69px">
                                                    ...
                                                    <td class="InterFaceTableRightRow">
                                                        <asp:DropDownList ID="cboCompany" runat="server" OnDataBound="cboCompany_DataBound"
                                                ...
                                                <tr>
                                                    <td class="InterFaceTableLeftRowUp" style="width: 69px">
                                                        OTP Notification Type</td>
                                                    <td class="InterFaceTableMiddleRowUp">
                                                    </td>
                                                    <td class="InterFaceTableRightRow">
                                                        <asp:DropDownList ID="ddNotificationType" runat="server" OnDataBound="ddlNotificaction_DataBound"
                                                            OnSelectedIndexChanged="ddlNotification_SelectedIndexChanged" Width="60%" style="font: menu">
                                                        </asp:DropDownList></td>
                                                </tr>
