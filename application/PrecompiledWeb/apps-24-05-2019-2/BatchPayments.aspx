<%@ page language="C#" masterpagefile="~/AccountBatch.master" autoeventwireup="true" inherits="BatchPayments, App_Web_peyqb8gx" title="BATCH PAYMENTS" enableviewstatemac="false" %>
<%@ Register 
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 98%; border-right: #617da6 1px solid; border-top: #617da6 1px solid; border-left: #617da6 1px solid; border-bottom: #617da6 1px solid;">
                    ...
                    <tr>
                        <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                            ...
                            <asp:DropDownList ID="cboBatchType" runat="server" Font-Bold="True" Width="95%">
                    ...
                    <tr>
                        ...
                        <td style="width: 40%; text-align: center">
                            <asp:Button ID="btnReconcile" runat="server" Font-Size="9pt" Height="23px" OnClick="btnReconcile_Click"
                                Text="BATCH PAYMENTS" Width="239px" style="font: menu" /></td>
