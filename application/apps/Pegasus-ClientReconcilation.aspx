<%@ Page Language="C#" MasterPageFile="~/Reconcilation.master" AutoEventWireup="true" CodeFile="Pegasus-ClientReconcilation.aspx.cs" Inherits="Pegasus_ClientReconcilation" Title="Untitled Page" %>
                            ...
                            <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                                <tr>
                                    <td class="InterfaceHeaderLabel">
                                        PEGASUS-CLIENT FILE RECONCILIATION</td>
                                </tr>
                            </table>
            </td>
        </tr>
                ...
                <table style="width: 90%" align="center">
                    <tr>
                        <td style="width: 100%; text-align: center; height: 2px;"><table cellpadding="0" cellspacing="0" class="style12" align="center" width="92%">
                            <tr>
                                <td style="width: 6%; vertical-align: top; height: 5px; text-align: left;">
                            ...
                            <tr>
                                <td style="vertical-align: top; width: 6%; height: 5px; text-align: left">
                                    <table align="center" cellpadding="0" cellspacing="0" style="width: 98%">
                                        <tr>
                                            <td class="InterFaceTableLeftRowUp" style="width: 118px; height: 20px">
                                                </td>
                        ...
                        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                               <%-- <asp:BoundColumn DataField="No." HeaderText="No.">
                                ...
                                <asp:BoundColumn DataField="PegasusVendorRef" HeaderText="PegasusVendorRef">
                                    <HeaderStyle Width="20%" />
                                    <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="ClientVendorRef" HeaderText="ClientVendorRef">
                                    <HeaderStyle Width="15%" />
                                    <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" />
                                </asp:BoundColumn>
                               
                                <asp:BoundColumn DataField="PegasusClientVendorRefStatus" HeaderText="STATUS">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Justify" Width="15%" />
