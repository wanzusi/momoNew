...
public class BusinessLogin
{
    ...
    public string ReconFilePath(string VendorCode, string fileName)
    {
        ...
        // DateTime actualtimeUpload = DateTime.Now.ToString("dd_MM_yyyy");
...
+ "</soapenv:Envelope>";
    ...
    public string DebitClientAccountBalance(string VendorTranld, string VendorCode, double AgentAccountNumber, double Amount, double PegasusAccountNumber, string PegasusAccountNetwork)
    {
        try
        {
            string status = "";
    ...
    public string VerifyPhoneNumberSingleBeneficiarry(string number)
    {
        ...
        try
        {
            ...
            if (network.Equals("AIRTEL") || network.Equals("MTN"))
            {
