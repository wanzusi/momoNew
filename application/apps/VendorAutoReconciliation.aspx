<%@ Page Language="C#" MasterPageFile="~/NewReconciliation.master" AutoEventWireup="true" CodeFile="VendorAutoReconciliation.aspx.cs" Inherits="VendorAutoReconciliation" Title="VENDOR AUTO RECONCILIATION" %>
                        ...
                        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                               <%-- <asp:BoundColumn DataField="No." HeaderText="No.">
                                ...
                                <asp:BoundColumn DataField="PegasusStatus" HeaderText="Reconciled">
                                ...
                                <asp:BoundColumn DataField="Recieved" HeaderText="Recieved">
                                    <HeaderStyle Width="15%" />
                                </asp:BoundColumn>
