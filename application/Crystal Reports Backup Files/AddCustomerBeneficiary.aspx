<%@ Page Language="C#" MasterPageFile="~/NewBeneficiaries.master" AutoEventWireup="true" CodeFile="AddCustomerBeneficiary.aspx.cs" Inherits="AddCustomerBeneficiary" Title="ADD CUSTOMER BENEFICIARIES" %>
                    ...
                    style="width: 90%">
                            ...
                            Code</td>
                                                        ...
                                                        <td class="InterFaceTableRightRow">
                                                            <asp:TextBox ID="txtCode" runat="server" CssClass="DataEntryFormTableTextbox DataEntryFormTableTextboxWidth"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="InterFaceTableLeftRowUp">
                                                            First Name</td>
                                                        ...
                                                        <td class="InterFaceTableRightRow">
                            <asp:TextBox ID="txtFname" runat="server" CssClass="DataEntryFormTableTextbox DataEntryFormTableTextboxWidth"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="InterFaceTableLeftRowUp">
                                                            Last Name</td>
                                                        ...
                                                        <td class="InterFaceTableRightRow">
                                                            <asp:TextBox ID="txtLname" runat="server" CssClass="DataEntryFormTableTextbox DataEntryFormTableTextboxWidth"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="InterFaceTableLeftRowUp">
                                                            Type</td>
                            ...
                            <asp:TextBox ID="txtEmail" runat="server" CssClass="DataEntryFormTableTextbox DataEntryFormTableTextboxWidth"></asp:TextBox></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="InterFaceTableRightRow" style="height: 20px">
                                                            <asp:TextBox ID="txtTitle" runat="server" CssClass="DataEntryFormTableTextbox DataEntryFormTableTextboxWidth"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="InterFaceTableLeftRowUp" style="height: 20px">
                            Location</td>
                            ...
                            Registered Name</td>
                                                        ...
                                                        <td class="InterFaceTableRightRow" style="height: 20px">
                            <asp:TextBox ID="TelRegName" runat="server" CssClass="DataEntryFormTableTextbox DataEntryFormTableTextboxWidth" Enabled="false"></asp:TextBox></td>
                                                    </tr>
                                                </table>
                                                &nbsp;</td>
                                        </tr>
                            ...
                            vertical-align: top; padding-top: 25px; text-align: center; height: 16px;">
                                ...
                                Height="30px" Text="Verify Number" Width="140px" OnClick="Button2_Click1" /></td>
                            </tr>
                            <tr style="color: #000000">
                                <td class="InterFaceTableLeftRowUp InterfaceTableColor" colspan="4" style="padding-bottom: 25px;
                            vertical-align: top; padding-top: 25px; text-align: center; height: 16px;">
                                    <asp:Button ID="btnSave" runat="server" CssClass="DataEntryFormTableButtons" Font-Bold="True"
                                Height="30px" OnClick="btnSave_Click" Text="SAVE" Width="140px" Visible="false" /></td>
                            </tr>
                        </table>
                    </asp:View>
                            ...
                            <tr style="color: #000000">
                                <td class="InterFaceTableRightRow" colspan="4" style="vertical-align: top; height: 2px;
                                    ...
                                    <table align="center" style="width: 80%">
                                        <tr>
                                            <td class="InterfaceHeaderLabel2" style="width: 50%; text-align:center;">
                                                Customer Code:</td>
                                            <td class="InterfaceHeaderLabel2" style="width: 50%; text-align:center;">
                                    Select Beneficiary Type</td>
                                        ...
                                        <tr>
                                            <td class="InterFaceTableLeftRowUp" style="width: 50%; text-align:center;">
                                                <asp:TextBox ID="txtCustCode2" runat="server" CssClass="DataEntryFormTableTextbox DataEntryFormTableTextboxWidth" Enabled="False"></asp:TextBox></td>
                                            <td class="InterFaceTableLeftRowUp" style="width: 50%; text-align:center;">
                                    <asp:DropDownList ID="cboType2" runat="server" CssClass="SystemDropdownListOthers DataEntryFormTableTextboxWidth"
                                OnDataBound="cboType2_DataBound" Width="65%">
                                    </asp:DropDownList></td>
                                        </tr>
                                    </table>
                                </td>
