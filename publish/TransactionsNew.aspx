<%@ page language="C#" masterpagefile="~/NewInternetwork.master" autoeventwireup="true" inherits="TransactionsNew, App_Web_zulwb1bx" title="TRANSACTIONS" enableviewstatemac="false" %>
...
<div class="col-lg-12 mt-2" style="display: flex; justify-content:space-evenly">
    ...
    <div class="col-md-2">
            <label for="UserCategory" class="form-label">Transaction Category</label>
    ...
    <div class="col-md-2">
     ...
     <div class="col-md-2">
      ...
      <div class="col-md-2">
            <label for="UserCategory" class="form-label">VendorId</label>
          <asp:TextBox ID="txtVendorTranId" runat="server" class="form-control" placeholder="Enter vendorid" />
          </div>
      <div class="col-md-2">
            <label for="UserCategory" class="form-label">PegPayId</label>
           <asp:TextBox ID="txtPegPayId" runat="server" CssClass="form-control" ></asp:TextBox>
          </div>
     ...
     <div class="col-md-2">
           ...
           <asp:TextBox ID="txtTelecomId" runat="server" CssClass="form-control" ></asp:TextBox>
          </div>
       ...
       <div class="col-md-2">
            <label for="UserCategory" class="form-label">Search</label>
                                ...
                                <div class="row">
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" Width="100%" CssClass="table table-bordered table-hover" ID="dataGridResults" AllowPaging="true"
                                            OnPageIndexChanging="OnPageIndexChanging" PageSize="1" CellPadding="4" CellSpacing="2">
