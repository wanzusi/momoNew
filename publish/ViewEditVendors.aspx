<%@ page language="C#" masterpagefile="~/NewAccounts.master" autoeventwireup="true" inherits="ViewEditVendors, App_Web_rnqohcbv" title="EDIT VENDORS" enableviewstatemac="false" %>
...
<div class="col-lg-10" style="display:flex; justify-content:space-around">
        <div class="col-md-2">
            <label for="inputState" class="form-label">Vendor</label>
           <asp:DropDownList ID="ddVendor" runat="server" CssClass="form-select"
                                style="font: menu;">
         ...
         <div class="col-md-2">
            <label for="inputState" class="form-label">Bank</label>
           <asp:DropDownList ID="ddTelecom" runat="server" CssClass="form-select"
                                style="font: menu;">
                                <asp:ListItem>True</asp:ListItem>
                                <asp:ListItem>False</asp:ListItem>
                            </asp:DropDownList>
          ...
          <div class="col-md-2" >
            ...
            <asp:DropDownList ID="ddTranType" runat="server" CssClass="form-select"
         ...
         <div class="col-md-2" style="margin-right:10px;" >
              ...
              <asp:Button ID="btnOK" runat="server"   OnClick="btnOK_Click" CssClass="btn btn-primary w-100"
                                Text="Search" style="font: menu; margin-top:25px;" />
          </div>
