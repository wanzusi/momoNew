<%@ page language="C#" masterpagefile="~/NewBatching.master" autoeventwireup="true" inherits="BatchPayments, App_Web_rnqohcbv" title="BATCH PAYMENTS" enableviewstatemac="false" %>
<%@ Register 
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <section class="section">
        <div class="text-center">
            <h5 class="card-title">TRANSACTIONS TO BATCH</h5>
        </div>
    </section>
...
<div class="col-lg-8" style="display: flex; justify-content:space-evenly">
       ...
       <asp:DropDownList ID="cboBatchType" runat="server" class="form-select">
              ...
              <div class="col-lg-6">
                  ...
                  <div class="col-md-2">
                            <asp:Button ID="btnReconcile" runat="server"  OnClick="btnReconcile_Click"
                                Text="BATCH PAYMENTS" class="btn btn-primary w-50" />
                </div>
                  <div class="col-md-2">
