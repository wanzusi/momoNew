<%@ page language="C#" masterpagefile="~/NewSystemTools.master" autoeventwireup="true" inherits="ApproveUser, App_Web_raqppk4d" enableviewstatemac="false" %>
...
<div class="col-lg-8" style="display: flex; justify-content:space-evenly">
          ...
          <div class="col-md-2">
           ...
           <asp:DropDownList ID="cboAreas" runat="server" AutoPostBack="True" CssClass="form-select"
            ...
            <label for="UserCategory" class="form-label">Company</label>
             <asp:DropDownList ID="cboBranches" runat="server" CssClass="form-select" OnDataBound="cboCostCenter_DataBound" >
                            </asp:DropDownList>
          </div>
    ...
    <section class="section">
               ...
               <asp:MultiView ID="MultiView1" runat="server">
                    ...
                    CellPadding="5" ForeColor="#333333" GridLines="Horizontal" OnItemCommand="DataGrid1_ItemCommand"
                    ...
                    <asp:View ID="View2" runat="server">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-2">
                                          <label class="form-label">Credit To Add</label>
                                          <asp:TextBox runat="server" CssClass="form-select" ID="txtCredit"></asp:TextBox>
                                      </div>
                                  </div>              
                               
                           <div class="row justify-content-center">
                               <div class="col-md-2">
                                     <asp:Button ID="BtnSave" runat="server" class="btn btn-success w-100"
                                        OnClick="BtnSave_Click" Style="font: menu" Text="ADD CREDIT" Width="106px" />
                               </div>
                           
                                  <div class="col-md-2" >
                                    <asp:Button ID="btnReturn" runat="server" class="btn  btn-primary w-100"
                                        OnClick="btnReturn_Click" Style="font: menu" Text="RETURN" Width="106px" />
                                      </div>
                         </div>
