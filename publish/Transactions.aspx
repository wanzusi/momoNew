<%@ page language="C#" masterpagefile="~/NewReports.master" autoeventwireup="true" inherits="Transactions, App_Web_rnqohcbv" title="TRANSACTIONS" enableviewstatemac="false" %>
...
<div class="col-lg-12 mt-2" style="display: flex; justify-content:space-evenly" >
   <div class="col-md-2">
     ...
     <div class="col-md-2">
      ...
      <div class="col-lg-10 mt-2" style="display: flex; justify-content:space-evenly" >
           <div class="col-md-2">
