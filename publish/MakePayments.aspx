<%@ page language="C#" masterpagefile="~/NewPayments.master" autoeventwireup="true" inherits="MakePayments, App_Web_rnqohcbv" title="MAKE PAYMENTS" enableviewstatemac="false" %>
                                    ...
                                    &nbsp;<table align="center" cellpadding="0" cellspacing="0" style="border-right: #617da6 1px solid;
                                        ...
                                        <tr>
                                            <td class="InterfaceHeaderLabel2" colspan="4" style="vertical-align: middle; height: 18px;
                                                text-align: center">
                                    Select Transaction Category</td>
                                    ...
                                    Select Beneficiary</td>
                                        ...
                                        <tr>
                                            <td colspan="4" style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                                                ...
                                                border-top-color: #617da6; height: 23px; text-align: center; border-right-width: 1px;
                                                border-right-color: #617da6">
                            <asp:DropDownList ID="cboTranCat" runat="server" CssClass="SystemDropdownListOthers DataEntryFormTableTextboxWidth"
                                OnDataBound="cboTranCat_DataBound" Width="55%" AutoPostBack="True">
                            </asp:DropDownList>
                                                &nbsp;</td>
                                                            ...
                                                            <td colspan="4" style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                                                               ...
                                                               <tr>
                                                                <td colspan="2" style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                                                                    ...
                                                                    width: 50%; border-top-color: #617da6; height: 23px; text-align: center; border-right-width: 1px;
                                                                    border-right-color: #617da6">
                                                                    <asp:DropDownList ID="ddVerifier" runat="server" AutoPostBack="True" CssClass="SystemDropdownListOthers DataEntryFormTableTextboxWidth"
                                                                        OnDataBound="ddVerifier_DataBound" OnSelectedIndexChanged="ddVerifier_SelectedIndexChanged" Width="70%">
                                                                    </asp:DropDownList>&nbsp;</td>
                            ...
                            text-align: center; height: 22px;">
                                ...
                                OnDataBound="cboType2_DataBound" Width="70%">
                                     ...
                                     <td colspan="1" style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                                                ...
                                                width: 259px; border-top-color: #617da6; height: 23px; text-align: center; border-right-width: 1px;
                                                border-right-color: #617da6">
                                                <asp:DropDownList ID="ddVerifier1" runat="server" CssClass="SystemDropdownListOthers DataEntryFormTableTextboxWidth"
                                OnDataBound="ddVerifier_DataBound" Width="70%" 
                                                    onselectedindexchanged="ddVerifier_SelectedIndexChanged">
                                    </asp:DropDownList></td>
                                            <td colspan="1" style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                                                border-bottom-width: 1px; border-bottom-color: #617da6; vertical-align: middle;
                                                width: 259px; border-top-color: #617da6; height: 23px; text-align: center; border-right-width: 1px;
                                                border-right-color: #617da6">
                                                <asp:DropDownList ID="cboTranCat1" runat="server" CssClass="SystemDropdownListOthers DataEntryFormTableTextboxWidth"
                                OnDataBound="cboTranCat_DataBound" Width="70%" 
                                                    >
                                    </asp:DropDownList></td>
                                            <td colspan="4" style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                                                border-bottom-width: 1px; border-bottom-color: #617da6; vertical-align: middle;
