<%@ page language="C#" masterpagefile="~/NewReconciliation.master" autoeventwireup="true" inherits="ReconReport, App_Web_jzvpb42g" title="TRANSACTIONS" enableviewstatemac="false" %>
...
<asp:DropDownList ID="cboVendor" runat="server" CssClass="form-select"
     ...
     <div class="col-md-2">
       ...
       <asp:TextBox ID="txtpartnerRef" runat="server" CssClass="form-control"></asp:TextBox>
          </div>
          <div class="col-md-2">
            <label for="UserCategory" class="form-label">Recon Status</label>
                 <asp:DropDownList ID="ddReconStatus" runat="server" CssClass="form-select" >
                            </asp:DropDownList>
          </div>
    <div class="col-md-2">
 ...
 <asp:TextBox ID="txtAccount" runat="server" CssClass="form-control"></asp:TextBox>
     ...
     <div class="col-md-2">
            <label for="inputEmail5" class="form-label">To Account</label>
             ...
             <asp:Button ID="btnConvert" runat="server"    CssClass="btn btn-primary w-100" OnClick="btnConvert_Click" Font-Bold="True"   Text="COVERT" />
                ...
                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="ReconType" HeaderText="Recon Type" Visible="true">
                            <HeaderStyle Width="10%" />
                            <ItemStyle Width="10%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="ReconciledBy" HeaderText="ReconciledBy" Visible="true">
                            <HeaderStyle Width="10%" />
                            <ItemStyle Width="10%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="ReconAtPegpay" HeaderText="IsAtVendor" Visible="true">
                            <HeaderStyle Width="1%" />
                            <ItemStyle Width="1%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="ReconAtTelecom" HeaderText="IsAtTelecom" Visible="true">
                            <HeaderStyle Width="1%" />
                            <ItemStyle Width="1%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="ReconciledDate" HeaderText="ReconciledDate" Visible="true">
                            <HeaderStyle Width="10%" />
                            <ItemStyle Width="10%" />
                        </asp:BoundColumn>
                    </Columns>
