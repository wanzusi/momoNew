<%@ page language="C#" masterpagefile="~/NewReconciliation.master" autoeventwireup="true" inherits="BackAutoReconciliation, App_Web_jzvpb42g" title="VENDOR AUTO RECONCILIATION" enableviewstatemac="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ajaxToolkit:ToolkitScriptManager runat="Server" EnableScriptGlobalization="true"
     ...
     <section class="section">
            ...
            <h5 class="card-title ">VENDOR FILE RECONCILIATION</h5>
...
<div class="col-lg-12" style="display: flex; justify-content:space-evenly">
    ...
    <asp:DropDownList ID="cboVendor" runat="server" class="form-select" AutoPostBack="true">
  ...
  <asp:CheckBox Text="" ID="chkboxArchieves" CssClass="form-check-input" runat="server" />
    ...
    <div class="col-lg-6" style="display:flex;">
        ...
        <div class="col-lg-2 text-center" style="margin-left:2vw">
             <asp:Button ID="btnConvert" runat="server"    CssClass="btn btn-primary w-75" OnClick="Button3_Click" Font-Bold="True"   Text="Convert To Pdf" />
        </div>
        ...
        <div class="col-lg-2 text-center" style="margin-left:2vw">
             <asp:Button ID="Button2" runat="server"    CssClass="btn btn-danger w-75" OnClick="Button1_Click" Font-Bold="True"   Text="RETURN" />
                ...
                <div class="text-center">
                     <asp:Button ID="Button4" runat="server" class="btn btn-primary w-75"  Text="CONVERT TO PDF"  OnClick="Button3_Click"  />
                        <asp:Button ID="Button1" runat="server"  class="btn btn-primary w-75"  Text="RETURN"  OnClick="Button1_Click"  />
