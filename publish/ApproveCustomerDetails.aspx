<%@ page language="C#" masterpagefile="~/NewCustomer.master" autoeventwireup="true" inherits="ApproveCustomerDetails, App_Web_1vhklsuy" title="APPROVE CUSTOMER DETAILS" enableviewstatemac="false" %>
 <%@ Register 
          ...
          <div class="col-md-3">
            ...
            <asp:Button ID="btnOK" runat="server" class="btn btn-primary w-75" style="margin-top:18px;" OnClick="btnOK_Click"
                    ...
                    style="width: 90%">
                                        ...
                                        <tr style="color: #000000">
                                            <td class="InterFaceTableLeftRowUp InterfaceTableColor" colspan="1" style="vertical-align: top;
                            text-align: left; height: 27px; width: 83px;">
                                                First
                                                Name</td>
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; height: 27px; width: 143px;">
                                                <asp:TextBox ID="txtFname" runat="server" Enabled="False" ></asp:TextBox></td>
                                            <td class="InterFaceTableLeftRowUp InterfaceTableColor" colspan="1" style="vertical-align: top;
                            text-align: left; height: 27px; width: 64px;">
                                                PassPort</td>
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; width: 30%; height: 27px;">
                                        ...
                                        <tr style="color: #000000">
                                            <td class="InterFaceTableLeftRowUp InterfaceTableColor" colspan="1" style="vertical-align: top;
                                                ...
                                                Last Name</td>
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; width: 143px;
                                            ...
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; width: 30%;
                                                height: 27px; text-align: left">
                                            </td>
                                        </tr>
                                        <tr style="color: #000000">
                            ...
                            text-align: left; width: 83px;">
                                                Email</td>
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; width: 143px;">
                            ...
                            text-align: left; width: 64px;">
                                                Driving Permit</td>
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; width: 30%;">
                                        ...
                                        <tr style="color: #000000">
                                            ...
                                            text-align: left; width: 83px; height: 24px;">
                                                Confirm Email</td>
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; width: 143px; height: 24px;">
                                            ...
                                            text-align: left; width: 64px; height: 24px;">
                                                Place of Work</td>
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; width: 30%; height: 24px;">
                                                <asp:TextBox ID="txtplaceofwork" runat="server" CssClass="DataEntryFormTableTextbox DataEntryFormTableTextboxWidth"
                                                    Height="30px" TextMode="MultiLine" EnableViewState="False" Enabled="False"></asp:TextBox></td>
                                        </tr>
                                        <tr style="color: #000000">
                                            <td class="InterFaceTableLeftRowUp InterfaceTableColor" colspan="1" style="vertical-align: top;
                                                text-align: left; width: 83px;">
                                        ...
                                        <tr style="color: #000000">
                                            <td class="InterFaceTableLeftRowUp InterfaceTableColor" colspan="1" style="vertical-align: top;
                                                ...
                                                Address</td>
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; height: 29px; width: 143px;">
                                            ...
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; width: 30%; height: 29px;">
                                                </td></tr>
                                        <tr style="color: #000000">
                                            <td class="InterFaceTableLeftRowUp InterfaceTableColor" colspan="1" style="vertical-align: top;
                                                text-align: left; height: 38px; width: 83px;">
                                                User Type</td>
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; height: 38px; width: 143px;"><asp:DropDownList ID="cboUserType" runat="server" Enabled="False" OnDataBound="cboUserType_DataBound"
                                              Style="font: menu"
                                                    Width="60%">
                                            </asp:DropDownList></td>
                                            <td class="InterFaceTableLeftRowUp InterfaceTableColor" colspan="1" style="vertical-align: top;
                                            ...
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; width: 30%; height: 38px;"></td>
                                        </tr>
                                        <tr style="color: #000000">
                                            <td class="InterFaceTableLeftRowUp InterfaceTableColor" colspan="1" style="vertical-align: top;
                                                text-align: left; height: 9px; width: 83px;">
                                                </td>
                                            <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; height: 9px; width: 143px;">
                                                </td>
                                            <td class="InterFaceTableLeftRowUp InterfaceTableColor" colspan="1" style="vertical-align: top;
                                        ...
                                        <tr style="color: #000000">
                                            <td class="InterFaceTableRightRow" colspan="4" style="vertical-align: top; padding-top: 5px;
                            ...
                            vertical-align: top; padding-top: 25px; text-align: center; height: 99px;">
                                ...
                                Height="30px" Text="APPROVE CUSTOMER" Width="170px" OnClick="btnSave_Click" />&nbsp;<br />
                    ...
                    style="width: 90%">
                                                ...
                                                <tr style="color: #000000">
                                                    <td class="InterFaceTableRightRow" colspan="4" style="vertical-align: top; height: 3px;
                            ...
                            text-align: left; height: 27px; width: 143px;">
                                                        Name</td>
                                                    <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; height: 27px; width: 172px;">
                            ...
                            text-align: left; height: 27px;">
                                                ...
                                                <tr style="color: #000000">
                                                    <td class="InterFaceTableLeftRowUp InterfaceTableColor" colspan="1" style="vertical-align: top;
                                                        ...
                                                        Contact Person</td>
                                                    <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; width: 172px;">
                                                ...
                                                <tr style="color: #000000">
                                                    <td class="InterFaceTableLeftRowUp InterfaceTableColor" colspan="1" style="vertical-align: top;
                                            text-align: left; width: 143px; height: 30px;">
                                                        Email</td>
                                                    <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; width: 172px; height: 30px;">
                                            ...
                                            text-align: left; height: 30px;">
                                                        Active</td>
                                                    <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; width: 30%; height: 30px;">
                                                ...
                                                text-align: left; height: 33px; width: 143px;">
                                                        Customer Type</td>
                                                    <td class="InterFaceTableRightRow" colspan="1" style="vertical-align: top; text-align: left; height: 33px; width: 172px;">
                                                        <asp:TextBox ID="txtCustType" runat="server" CssClass="DataEntryFormTableTextbox DataEntryFormTableTextboxWidth"
                            ...
                            <tr>
                                <td style="padding-bottom: 10px; vertical-align: top; text-align: center; height: 71px; width: 664px;">
                                    ...
                                    <asp:Label ID="lblCustomerCode" runat="server" Text="0" Visible="False"></asp:Label></td>
                            </tr>
                        </table>
