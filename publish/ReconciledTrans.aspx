<%@ page language="C#" masterpagefile="~/Reconcilation.master" autoeventwireup="true" inherits="ReconciledTrans, App_Web_dz3he2w4" title="RECONCILED TRANSACTIONS" enableviewstatemac="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="text-center">
            <h5 class="card-title">RECONCILED TRANSACTIONS</h5>
        </div>
    </section>
            ...
            <td style="width: 98%; height: 2px">
                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="SentDate" HeaderText="SentDate">
                            <HeaderStyle Width="10%" />
                            <ItemStyle Width="10%" />
                        </asp:BoundColumn>
