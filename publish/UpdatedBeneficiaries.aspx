<%@ page language="C#" masterpagefile="~/NewBeneficiaries.master" autoeventwireup="true" inherits="UpdatedBeneficiaries, App_Web_rgb2gjqg" title="UPDATED CUSTOMER BENEFICIARIES" enableviewstatemac="false" %>
 <%@ Register 
              ...
              <asp:MultiView ID="MultiView1" runat="server">
                    <asp:View ID="View1" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="col-md-2">
                                    <asp:Button ID="btnApprove" runat="server" CssClass="btn btn-primary w-50"
                                    OnClick="btnApprove_Click" Text="APPROVE" Width="150px" />
                                </div>
                                <div class="col-md-2">
                                                                    
                                <asp:Button ID="btnReject" runat="server" CssClass="btn btn-danger w-50"
