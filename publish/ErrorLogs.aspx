<%@ page language="C#" masterpagefile="~/NewReports.master" autoeventwireup="true" inherits="ErrorLogs, App_Web_1vhklsuy" title="View Error Logs" enableviewstatemac="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="section">
        <div class="text-center">
            <h5 class="card-title">VIEW ERROR LOGS</h5>
        </div>
    </section>
...
<div class="col-lg-10 mb-3" style="display: flex; justify-content:space-evenly">
      ...
      <div class="col-md-2">
            <label for="inputEmail5" class="form-label">VendorTranId</label>
    ...
    <div class="col-md-2">
            <label for="inputEmail5" class="form-label">Error</label>
            <asp:TextBox ID="txtError" runat="server" class="form-control"></asp:TextBox>
          </div>
